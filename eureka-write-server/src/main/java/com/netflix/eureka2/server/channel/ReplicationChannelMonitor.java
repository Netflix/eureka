...
public class ReplicationChannelMonitor {
    ...
    private final AtomicReference<SenderReplicationChannel> replicationChannelRef = new AtomicReference<>();
    ...
    private void connect() {
        ...
        closeChannel();
        SenderReplicationChannel replicationChannel = new SenderReplicationChannel(
    ...
    protected void closeChannel() {
        SenderReplicationChannel replicationChannel = replicationChannelRef.getAndSet(null);
