...
public class EurekaHttpClientsTest {
    ...
    public void testCompositeBootstrapResolver() throws Exception {
        ...
        try {
            resolver = EurekaHttpClients.compositeBootstrapResolver(clientConfig, transportConfig, transportClientFactory, applicationInfoManager.getInfo(), applicationsSource, randomizer);
