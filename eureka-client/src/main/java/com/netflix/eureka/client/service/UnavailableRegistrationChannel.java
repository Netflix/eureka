...
/**
 * This channel instance is returned to clients when there is a problem with connecting
 * to Eureka server.
 *
 * @author Tomasz Bak
 */
public class UnavailableRegistrationChannel implements RegistrationChannel {
    public static final RegistrationChannel INSTANCE = new UnavailableRegistrationChannel();

    protected UnavailableRegistrationChannel() {
    }
