...
public class EurekaSourcedServerList implements ServerList<Server> {
    ...
    private static final String SURO_VIP_KEY = "eureka.ext.suro.vip";
    ...
    public EurekaSourcedServerList(ServerResolver<InetSocketAddress> readClusterResolver) {
    ...
    protected void subscribeToSuro() {
        eurekaClient.forVips(SURO_VIP_KEY).subscribe(new ServerListUpdater());
    }
        ...
        public void onNext(ChangeNotification<InstanceInfo> notification) {
            ...
            switch (notification.getKind()) {
                ...
                case Modify:
                    ...
                    // TODO: define default ports in transport so we can use constant here
                    servers.put(instanceId, new Server(address.getIpAddress(), 7003));
                case Delete:
