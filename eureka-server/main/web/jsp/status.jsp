...
<html>
  <head>
    ...
    <title>Discovery - <%= ContainerContext.VERSION %></title>
  ...
  <body id="one">
    ...
    <div id="content">
      <div class="sectionTitle">Instances currently registered with discovery</div>
        <table id='instances' class="stripeable">
          <tr><th>Application</th><th>AMIs</th><th>Availability Zones</th><th>Status</th></tr>
           <%
           for(Application app : ReplicaAwareInstanceRegistry.getInstance().getSortedApplications()) {
