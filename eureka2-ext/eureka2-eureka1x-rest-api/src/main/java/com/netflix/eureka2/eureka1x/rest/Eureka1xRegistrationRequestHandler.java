...
import com.netflix.eureka2.eureka1x.rest.registry.Eureka1xRegistryProxyImpl;
 ...
 * @author Tomasz Bak
 */
public class Eureka1xRegistrationRequestHandler extends AbstractEureka1xRequestHandler {

    private final Eureka1xRegistryProxy registryProxy;

    /* For testing */
    public Eureka1xRegistrationRequestHandler(Eureka1xRegistryProxy registryProxy,
    ...
    @Inject
    public Eureka1xRegistrationRequestHandler(RegistrationClientProvider registrationClientProvider) {
        this.registryProxy = new Eureka1xRegistryProxyImpl(registrationClientProvider.get(), Schedulers.io());
    }
