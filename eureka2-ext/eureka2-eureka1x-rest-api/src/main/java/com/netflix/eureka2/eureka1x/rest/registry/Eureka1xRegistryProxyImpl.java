 ...
 * @author Tomasz Bak
 */
public class Eureka1xRegistryProxyImpl implements Eureka1xRegistryProxy {

    private static final Logger logger = LoggerFactory.getLogger(Eureka1xRegistryProxyImpl.class);
    ...
    public Eureka1xRegistryProxyImpl(EurekaRegistrationClient registrationClient, Scheduler scheduler) {
