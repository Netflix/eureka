 ...
 * @author Tomasz Bak
 */
public class Eureka1xRegistryProxyImplTest {
    ...
    private final Eureka1xRegistryProxyImpl registryProxy = new Eureka1xRegistryProxyImpl(registrationClient, testScheduler);
