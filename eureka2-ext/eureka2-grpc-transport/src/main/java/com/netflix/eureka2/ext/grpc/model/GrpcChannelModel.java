...
/**
 */
public class GrpcChannelModel extends ChannelModel {
    private static final ChannelModel INSTANCE = new GrpcChannelModel();

    @Override
    public Heartbeat newHeartbeat() {
        return GrpcHeartbeatWrapper.getInstance();
    }
    ...
    public static ChannelModel getGrpcModel() {
        return INSTANCE;
    }
}
