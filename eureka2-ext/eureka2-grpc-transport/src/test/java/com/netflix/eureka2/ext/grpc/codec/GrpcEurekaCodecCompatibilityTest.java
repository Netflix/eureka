...
/**
 */
public class GrpcEurekaCodecCompatibilityTest extends EurekaCodecCompatibilityTest {

    public GrpcEurekaCodecCompatibilityTest() {
        super(new GrpcEurekaCodecFactory());
    }
