...
/**
 * Ignore until GRPC supports shutdown now functionality to interrupt pending calls.
 */
@Ignore
public class GrpcConnectionLifecycleCompatibilityTestSuite extends ConnectionLifecycleCompatibilityTestSuite {
    static {
