 ...
 * @author Tomasz Bak
 */
public class Eureka1xClientResource extends EurekaExternalResource {
    ...
    public Eureka1xClientResource(String eurekaPropertyFile, String appName, int serverPort) {
