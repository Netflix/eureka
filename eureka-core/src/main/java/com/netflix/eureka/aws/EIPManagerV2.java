/*
 * This class is intended to replace EIPManager in the next major version of eureka-core.
 * For now the code is split allowing optional use of aws jdk version 2
 *
 * Compare to EIPManager to understand differences.
 */
 ...
 */
@Singleton
public class EIPManagerV2 implements AwsBinder {
    ...
    @Inject
    public EIPManagerV2(EurekaServerConfig serverConfig,
