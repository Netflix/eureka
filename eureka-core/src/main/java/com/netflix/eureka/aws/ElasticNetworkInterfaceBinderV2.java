/*
 * This class is intended to replace ElasticNetworkInterfaceBinder in the next major version of eureka-core.
 * For now the code is split allowing optional use of aws jdk version 2
 * Compare to ElasticNetworkInterfaceBinder to understand changes.
 */
 ...
 */
public class ElasticNetworkInterfaceBinderV2 implements AwsBinder {
    ...
    @Inject
    public ElasticNetworkInterfaceBinderV2(
    ...
    public void bind() throws MalformedURLException {
        ...
        DescribeNetworkInterfacesResponse result = ec2Service
                .describeNetworkInterfaces(DescribeNetworkInterfacesRequest.builder()
