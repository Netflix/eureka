...
import static com.netflix.discovery.util.EurekaMonitors.CANCEL;
import static com.netflix.discovery.util.EurekaMonitors.CANCEL_NOT_FOUND;
import static com.netflix.discovery.util.EurekaMonitors.EXPIRED;
import static com.netflix.discovery.util.EurekaMonitors.GET_ALL_CACHE_MISS;
import static com.netflix.discovery.util.EurekaMonitors.GET_ALL_CACHE_MISS_DELTA;
import static com.netflix.discovery.util.EurekaMonitors.REGISTER;
import static com.netflix.discovery.util.EurekaMonitors.RENEW;
import static com.netflix.discovery.util.EurekaMonitors.RENEW_NOT_FOUND;
import static com.netflix.discovery.util.EurekaMonitors.STATUS_UPDATE;
...
LookupService<String> {
     ...
     * (non-Javadoc)
     * 
     * @see com.netflix.discovery.lease.LeaseManager#register(java.lang.Object,
     * int, long, boolean)
     */
     ...
     * (non-Javadoc)
     * 
     * @see com.netflix.discovery.lease.LeaseManager#renew(java.lang.String,
     ...
     * (non-Javadoc)
     * 
     * @see com.netflix.discovery.lease.LeaseManager#evict()
     */
    public void evict() {
