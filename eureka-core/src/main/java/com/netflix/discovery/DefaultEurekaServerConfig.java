...
public class DefaultEurekaServerConfig implements EurekaServerConfig {
    ...
    /*
     * (non-Javadoc)
     * @see com.netflix.discovery.EurekaServerConfig#getAWSAccessId()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.netflix.discovery.EurekaServerConfig#getAWSSecretKey()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.netflix.discovery.EurekaServerConfig#getEIPBindRebindRetries()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.netflix.discovery.EurekaServerConfig#getEIPBindingRetryInterval()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.netflix.discovery.EurekaServerConfig#shouldEnableSelfPreservation()
     */
    @Override
    ...
    /*
     * (non-Javadoc)
     * @see com.netflix.discovery.EurekaServerConfig#getPeerEurekaNodesUpdateInterval()
     */
    @Override
