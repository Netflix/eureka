...
public class Index<T> extends Subject<ChangeNotification<T>, ChangeNotification<T>> {
    ...
    /**
     * An initial data source for {@link com.netflix.rx.eureka.interests.Index}.
     *
     * <h2>Producer</h2>
     * There will always be a single producer (even if multiple the updates will be sequenced out of this context of
     * this holder) queue.
     *
     * The producer will always be the {@link com.netflix.rx.eureka.interests.Index}, the updates to which
