...
import com.netflix.rx.eureka.transport.codec.json.JsonPipelineConfigurator;
...
public final class EurekaTransports {
    ...
    static final String REPLICATION_ENVELOPE_TYPE = "com.netflix.rx.eureka.protocol.replication.ReplicationMessages";

    static final String DISCOVERY_SCHEMA_FILE = "discovery-schema.avpr";
    static final String DISCOVERY_ENVELOPE_TYPE = "com.netflix.rx.eureka.protocol.discovery.DiscoveryMessage";
