...
public class BaseMessageConnectionTest {
    ...
    public void setUp() throws Exception {
        ...
        setupServerAndClient(-1, -1);
    }

    private void setupServerAndClient(final long serverLifecycleDuration, final long clientLifecycleDuration) throws Exception {
        ...
        server = RxNetty.newTcpServerBuilder(0, new ConnectionHandler<Object, Object>() {
            ...
            public Observable<Void> handle(ObservableConnection<Object, Object> connection) {
                BaseMessageConnection messageBroker = new BaseMessageConnection("testServer", connection, serverLifecycleDuration, serverMetrics);
        ...
        Observable<MessageConnection> clientObservable = RxNetty.newTcpClientBuilder("localhost", port)
                ...
                .map(new Func1<ObservableConnection<Object, Object>, MessageConnection>() {
                    ...
                    public MessageConnection call(ObservableConnection<Object, Object> connection) {
                        return new BaseMessageConnection("testClient", connection, clientLifecycleDuration, clientMetrics);
                    }
                });
    ...
    public void testSelfTermination() throws Exception {
        tearDown();  // tear down the auto setup server and client
        setupServerAndClient(-1, 2);  // setup a client with a message connection that terminates after 2 seconds
