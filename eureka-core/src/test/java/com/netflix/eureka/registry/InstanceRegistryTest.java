...
public class InstanceRegistryTest extends AbstractTester {
    ...
    public void testStatusOverrideSetAndRemoval() throws Exception {
        ...
        InstanceInfo myInstance2 = new InstanceInfo(seed);
        // use a later 'client side' dirty timestamp
        myInstance2.setLastDirtyTimestamp(200l);
    ...
    public void testEvictionTaskCompensationTime() throws Exception {
        ...
        when(testTask.getCurrentTimeNano()).thenReturn(// less than the period
        1l).thenReturn(// exactly 1 period
        1l + evictionTaskPeriodNanos).thenReturn(// 10ms longer than 1 period
        1l + evictionTaskPeriodNanos * 2 + 10000000l).thenReturn(// less than 1 period
        1l + evictionTaskPeriodNanos * 3 - 1l);
