...
//import com.netflix.eureka2.registry.data.MultiSourcedInstanceInfoHolder;
...
//
///**
// * An implementation of {@link EurekaRegistry} that uses a
// * {@link com.netflix.eureka2.registry.data.MultiSourcedDataHolder} to store multiple copies of entries when the copies
...
// */
//@Singleton
//public class SourcedEurekaRegistryImpl implements EurekaRegistry<InstanceInfo> {
//
//    private static final Logger logger = LoggerFactory.getLogger(SourcedEurekaRegistryImpl.class);
//
//    protected final ConcurrentMap<String, MultiSourcedInstanceInfoHolder> internalStore;
...
//                        }
//
//                        MultiSourcedInstanceInfoHolder holder = internalStore.get(instanceInfo.getId());
//                        switch (notification.getKind()) {
//                            case Add:
//                                if (holder == null) {
//                                    holder = new MultiSourcedInstanceInfoHolder(registryChangeSubject, instanceInfo.getId(), metrics);
...
//        for (MultiSourcedInstanceInfoHolder holder : internalStore.values()) {
...
//        final Collection<MultiSourcedInstanceInfoHolder> eurekaHolders = internalStore.values();
...
//        private final Iterator<MultiSourcedInstanceInfoHolder> delegate;
//        private ChangeNotification<InstanceInfo> next;
//
//        private FilteredIterator(Interest<InstanceInfo> interest, Iterator<MultiSourcedInstanceInfoHolder> delegate) {
