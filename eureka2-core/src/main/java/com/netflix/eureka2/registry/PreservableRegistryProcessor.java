...
public class PreservableRegistryProcessor implements EurekaRegistrationProcessor<InstanceInfo> {
    ...
    @Override
    public Observable<Void> register(final Observable<InstanceInfo> registrationUpdates, final Source source) {
        return Observable.create(new OnSubscribe<Void>() {
            ...
            public void call(final Subscriber<? super Void> clientSubscriber) {
                ...
                delegate.register(delegateUpdates, source).subscribe(new Subscriber<Void>() {
                    @Override
