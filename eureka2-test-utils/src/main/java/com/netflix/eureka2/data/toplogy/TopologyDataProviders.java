...
public final class TopologyDataProviders {
    ...
    public static ServiceTopologyGenerator serviceTopologyGeneratorFor(String topologyId, int targetRegistrationLevel) {
        ...
        int topologySize = Math.max(100, (int) (targetRegistrationLevel * 1.25));
