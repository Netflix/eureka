...
/**
 */
public class StdReplicationHello implements ReplicationHello {

    private final StdSource source;
    private final int registrySize;

    // For serialization frameworks
    protected StdReplicationHello() {
        this.source = null;
        this.registrySize = 0;
    }

    public StdReplicationHello(StdSource source, int registrySize) {
        this.source = source;
    ...
    public boolean equals(Object o) {
        ...
        StdReplicationHello that = (StdReplicationHello) o;
    ...
    public String toString() {
        return "StdReplicationHello{source=" + source + ", registrySize=" + registrySize + '}';
    }
}
