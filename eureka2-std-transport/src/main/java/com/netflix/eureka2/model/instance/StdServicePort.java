 ...
 * Client needs to be aware of those names to extract the desired information from the {@link StdInstanceInfo} object.
 ...
 * @author Tomasz Bak
 */
public class StdServicePort implements ServicePort {
    ...
    public StdServicePort(Integer port, boolean secure) {
        this(null, port, secure, null);
    }

    public StdServicePort(String name, Integer port, boolean secure) {
        this(name, port, secure, null);
    }

    public StdServicePort(String name, Integer port, boolean secure, Set<String> addressLabels) {
        this.name = name;
        this.port = port;
        this.secure = secure;
    ...
    public boolean equals(Object o) {
        ...
        StdServicePort that = (StdServicePort) o;
    ...
    public static class ServicePortBuilder {
        ...
        public StdServicePort build() {
            return new StdServicePort(name, port, secure, addressLabels);
        }
    }
}
